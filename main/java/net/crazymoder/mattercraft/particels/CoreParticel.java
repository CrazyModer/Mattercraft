package net.crazymoder.mattercraft.particels;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;
import net.crazymoder.mattercraft.manager.ResourceManager;
import net.minecraft.client.particle.EntityFX;
import net.minecraft.client.renderer.Tessellator;
import net.minecraft.world.World;

public class CoreParticel extends EntityFX {
	double originalX;
	double originalZ;

	public CoreParticel(World par1World, double par2, double par4, double par6, float par8, float par9, float par10, float scale) {
		this(par1World, par2, par4, par6, 1.0F, par8, par9, par10, scale);
	}

	public CoreParticel(World world, double par2, double par4, double par6, float par8, float par9, float par10, float par11, float scale) {
