...
import net.crazymoder.mattercraft.tileentity.WaterInjectorTile;
...
public class WaterInjector extends BlockContainer
{	
	public WaterInjector() {
		super(Material.iron);
	}

	@Override
	public TileEntity createNewTileEntity(World arg0, int arg1) {
		return new WaterInjectorTile();
	}
